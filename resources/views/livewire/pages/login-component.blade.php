        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Selamat datang di WareHouse! 👋</h4>
                    <p class="mb-4">Silakan Masuk untuk Mengakses Data Gudang Anda</p>

                    <form wire:submit.prevent="login()" id="formAuthentication" class="mb-3">
                        <div class="mb-3">
